...
public class AssetLibrary {
    ...
    public static final Font TITLE_FONT = Objects
            .requireNonNull(Font.font("Fira Sans", FontWeight.BOLD, FontPosture.REGULAR, 64)),
            GUI_FONT = Objects.requireNonNull(Font.font("Fira Sans", FontWeight.BOLD, FontPosture.REGULAR, 32)),
            TEXT_FONT = Objects.requireNonNull(Font.font("Sans", FontWeight.NORMAL, FontPosture.REGULAR, 24));
    // #endregion

    private static @Nullable AssetLibrary instance;
    ...
    public TileData getTileInfo(int i) {
    ...
    public LevelData getLevelData(String s) {
    ...
    private void loadLevelData() {
        ...
        Arrays.stream(levels).forEach(l -> {
            ...
            LevelData levelData = deserializeLevelData(LEVEL_DIR_PREFIX + levelFilename);
